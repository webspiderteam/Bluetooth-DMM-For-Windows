...
namespace BluetoothLEExplorer.Models
{
    ...
    public class GattSampleContext : INotifyPropertyChanged
    {
        ...
        //public String ChatacteristicData { get; set; } = "";

        private String _MyGattCData = string.Empty;

        public string MyGattCData
        {
            get
            {
                return _MyGattCData;
            ...
            set
            {
                if (_MyGattCData != value)
                {
                    _MyGattCData = value;
                    OnPropertyChanged(new PropertyChangedEventArgs("MyGattCData"));
                }
            }
        }

        private String _MyGattCDataSymbol = string.Empty;

        public string MyGattCDataSymbol
        {
            get
            {
                return _MyGattCDataSymbol;
            }

            set
            {
                if (_MyGattCDataSymbol != value)
                {
                    _MyGattCDataSymbol = value;
                    OnPropertyChanged(new PropertyChangedEventArgs("MyGattCDataSymbol"));
                }
            }
        }

        private string _MyGattCDataACDC = String.Empty;

        public String MyGattCDataACDC
        {
            get
            {
                return _MyGattCDataACDC;
            }

            set
            {
                if (_MyGattCDataACDC != value)
                {
                    _MyGattCDataACDC = value;
                    OnPropertyChanged(new PropertyChangedEventArgs("MyGattCDataACDC"));
                }
            }
        }
        private bool _MyGattCDataAutoRange = false;

        public bool MyGattCDataAutoRange
        {
            get
            {
                return _MyGattCDataAutoRange;
            }

            set
            {
                if (_MyGattCDataAutoRange != value)
                {
                    _MyGattCDataAutoRange = value;
                    OnPropertyChanged(new PropertyChangedEventArgs("MyGattCDataAutoRange"));
                }
            }
        }
        private bool _MyGattCDataTrue_RMS = false;

        public bool MyGattCDataTrue_RMS
        {
            get
            {
                return _MyGattCDataTrue_RMS;
            }

            set
            {
                if (_MyGattCDataTrue_RMS != value)
                {
                    _MyGattCDataTrue_RMS = value;
                    OnPropertyChanged(new PropertyChangedEventArgs("MyGattCDataTrue_RMS"));
                }
            }
        }
        private bool _MyGattCDataDiode = false;

        public bool MyGattCDataDiode
        {
            get
            {
                return _MyGattCDataDiode;
            }

            set
            {
                if (_MyGattCDataDiode != value)
                {
                    _MyGattCDataDiode = value;
                    OnPropertyChanged(new PropertyChangedEventArgs("MyGattCDataDiode"));
                }
            }
        }

        private bool _MyGattCDataContinuity = false;

        public bool MyGattCDataContinuity
        {
            get
            {
                return _MyGattCDataContinuity;
            }

            set
            {
                if (_MyGattCDataContinuity != value)
                {
                    _MyGattCDataContinuity = value;
                    OnPropertyChanged(new PropertyChangedEventArgs("MyGattCDataContinuity"));
                }
            }
        }

        private bool _MyGattCDataHold = false;

        public bool MyGattCDataHold
        {
            get
            {
                return _MyGattCDataHold;
            }

            set
            {
                if (_MyGattCDataHold != value)
                {
                    _MyGattCDataHold = value;
                    OnPropertyChanged(new PropertyChangedEventArgs("MyGattCDataHold"));
                }
            }
        }

        private bool _MyGattCDataMin = false;

        public bool MyGattCDataMin
        {
            get
            {
                return _MyGattCDataMin;
            }

            set
            {
                if (_MyGattCDataMin != value)
                {
                    _MyGattCDataMin = value;
                    OnPropertyChanged(new PropertyChangedEventArgs("MyGattCDataMin"));
                }
            }
        }

        private bool _MyGattCDataMax = false;

        public bool MyGattCDataMax
        {
            get
            {
                return _MyGattCDataMax;
            }

            set
            {
                if (_MyGattCDataMax != value)
                {
                    _MyGattCDataMax = value;
                    OnPropertyChanged(new PropertyChangedEventArgs("MyGattCDataMax"));
                }
            }
        }
