...
namespace BluetoothLEExplorer.ViewModels
{
    ...
    public class DeviceServicesPageViewModel : ViewModelBase
    {
        ...
        public string MyGattCDataSymbol
        {
            get
            {
                return context.MyGattCDataSymbol;
        ...
        public string MyGattCDataACDC
        {
            get
            {
                return context.MyGattCDataACDC;
        ...
        public bool MyGattCDataAutoRange
        {
            get
            {
                return context.MyGattCDataAutoRange;
        ...
        public bool MyGattCDataTrue_RMS
        {
            get
            {
                return context.MyGattCDataTrue_RMS;
        ...
        public bool MyGattCDataDiode
        {
            get
            {
                return context.MyGattCDataDiode;
        ...
        public bool MyGattCDataContinuity
        {
            get
            {
                return context.MyGattCDataContinuity;
        ...
        public bool MyGattCDataHold
        {
            get
            {
                return context.MyGattCDataHold;
        ...
        //    get
        //    {
        //        return context.ConnectionAlive;
        //    }
        //}
